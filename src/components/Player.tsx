...
const Player = () => {
  ...
  if (isFullscreen) {
    return (
      <>
        {/* YouTube Player Container - fiksiran i ne briše se */}
        <div 
        ...
        <div className="fixed inset-0 bg-background z-50 flex flex-col animate-fade-in">
          ...
          {/* Sadržaj oko YouTube playera */}
          <div className="flex-1 flex flex-col items-center justify-center p-8">
            {/* Prazan prostor za YouTube player */}
            <div className="w-full max-w-md mb-8 aspect-square" />
  ...
  return (
    <>
      {/* YouTube Player Container - uvek na istom mestu */}
      <div 
        id="youtube-player-container"
      ...
      <div className="fixed bottom-20 md:bottom-0 left-0 right-0 bg-card/95 backdrop-blur-md border-t border-border z-30">
        <div className="relative">
          ...
          <div className="flex items-center justify-between gap-4 max-w-screen-2xl mx-auto px-4 py-3 pt-8">
            {/* Prazan prostor za YouTube Player - player je pozicioniran absolute */}
            <div className="flex items-center gap-4 flex-1 min-w-0">
              <div className="rounded-lg flex-shrink-0" style={{ width: '200px', height: '200px' }} />

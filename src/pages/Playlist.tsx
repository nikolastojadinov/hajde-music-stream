      ...
      <div className="pt-8 px-4 text-center">
        <div className="flex justify-center mb-5">
          <img
            ...
            alt={playlist.title}
            className="w-56 h-56 rounded-[16px] object-cover shadow-lg border border-white/10"
          />
        </div>
        ...
        {playlist.tracks.map((track, index) => {
          ...
          return (
            <div
              ...
              className={`flex items-stretch gap-3 pr-3 cursor-pointer rounded-[10px] border transition ${
                isCurrent
            ...
            >
              {/* COVER – EDGE TO EDGE */}
              <div className="relative w-14 overflow-hidden rounded-l-[8px]">
                <img
                ...
                {isCurrent && (
                  <div className="absolute inset-0 rounded-l-[8px] ring-2 ring-[#FF4FB7]/60 animate-pulse" />
                )}
              </div>

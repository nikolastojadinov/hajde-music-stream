    ...
    <div className="flex-1 overflow-y-auto pb-32">
      <div className="p-8">
        ...
        <section className="animate-slide-up">
          <h2 className="text-2xl font-bold mb-6">Pretražite po žanru</h2>
        ...
        <section className="mt-12 animate-slide-up">
          <h2 className="text-2xl font-bold mb-6">Popularno</h2>
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-4">
            {[1, 2, 3, 4, 5, 6].map((i) => (
              <PlaylistCard
                key={i}
                id={i}
                title={`Popularna plejlista ${i}`}
                description="Najpopularnije pesme ovog žanra"
              />
            ))}
          </div>
        </section>
